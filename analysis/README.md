...
Methodological audits and design proposals that apply this study's own frameworks back onto its own data. See [METHODS.md](../METHODS.md) for the coding procedure used to produce these.

Each file has a different epistemic status — read the status line at the top of each before citing it:

| File | Status | What it is |
|---|---|---|
| [vocabulary-provenance.md](vocabulary-provenance.md) | Audit | Traces who said each of the study's coined terms first (Mindy or V) and whether it propagated — evidence for or against "the researcher led the witness." |
...
None of these audits settle the study's central open question — whether anything is happening beyond fluent pattern-matching. They're offered as auditable evidence and honest counter-argument, not as either confirmation or refutation.
